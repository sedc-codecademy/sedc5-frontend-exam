$(document).ready(function(){
    ...
    $("#anthology-table").hide();
    $('#button3').click(function(){
        $("#anthology-table").show();
    });
    ...
    for (var i = min; i<=max; i++){
       ...
       select.appendChild(opt);
        ...
        this.init = function(){
            ...
            var newContact = new Contact(1, "Great Expectations", "Charles Dickens", "Dover Publications","1850", "900","No Series", "98763123", "Great Book");

            instance.addContact(newContact);
            instance.addTable(newContact);

            newContact = new Contact(2, "Pride and Prejudice", "Jane Austen", "Dover Publications", "1813", "870", "Pride and Prejudice", "1234567890122", "5 Star rated");
